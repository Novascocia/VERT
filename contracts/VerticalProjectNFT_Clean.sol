...
contract VerticalProjectNFT is ERC721URIStorage, IERC2981, Ownable, Pausable, ReentrancyGuard {
    ...
    /**
     * @dev Manual sync function for admin use
     * Syncs actual VERT token balance with recorded prize pool
     * Returns the amount that was synced
     */
    function syncPrizePool() external onlyOwner returns (uint256) {
    ...
    /**
     * @dev Support for ERC-721 standard functions
     */
    function name() public view virtual override returns (string memory) {
        return "Vertical Project";
    }
